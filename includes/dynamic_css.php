...
function avada_dynamic_css_array() {
	...
	if ( ! $site_width_percent ) {
		...
		if ( Avada()->settings->get( 'responsive' ) ) {
			...
			$media_query = '@media only screen and (max-width: ' . fusion_strip_unit( Avada_Sanitize::size( Avada()->settings->get( 'side_header_break_point' ) ) ) . 'px)';
            ...
            $css[$media_query][avada_implode( $elements )]['padding-left']  = $hundred_perecent_width_padding . '!important';
            $css[$media_query][avada_implode( $elements )]['padding-right'] = $hundred_perecent_width_padding . '!important';

			$elements = array(
				'.width-100 .fullwidth-box',
				'.width-100 .fusion-section-separator'
			);
            $css[$media_query][avada_implode( $elements )]['margin-left']   = sprintf( '-%s!important', $hundred_perecent_width_padding );
            $css[$media_query][avada_implode( $elements )]['margin-right']  = sprintf( '-%s!important', $hundred_perecent_width_padding );
	...
	if ( ! Avada()->settings->get( 'responsive' ) ) {
		...
		$media_query = '@media screen and (max-width: ' . fusion_strip_unit( Avada_Sanitize::size( Avada()->settings->get( 'side_header_break_point' ) ) ) . 'px)';
		...
		$media_query = '@media screen and (max-width: ' . fusion_strip_unit( Avada_Sanitize::size( Avada()->settings->get( 'side_header_break_point' ) ) ) - 18 . 'px)';
	...
	if ( Avada()->settings->get( 'responsive' ) ) {
		...
		$media_query = '@media only screen and (max-width: ' . fusion_strip_unit( Avada_Sanitize::size( Avada()->settings->get( 'side_header_break_point' ) ) ) . 'px)';
		$mobile_header_media_query = '@media only screen and (max-width: ' . fusion_strip_unit( Avada_Sanitize::size( Avada()->settings->get( 'side_header_break_point' ) ) ) . 'px)';
		...
		$css[$media_query]['#side-header .side-header-wrapper']['position'] = 'relative';
		...
		$css[$media_query]['#side-header.fusion-mobile-menu-design-modern .fusion-logo-menu-right .fusion-mobile-menu-icons']['position'] = 'static';
		$css[$media_query]['#side-header.fusion-mobile-menu-design-modern .fusion-logo-menu-right .fusion-mobile-menu-icons a']['float'] = 'left';
		$css[$media_query]['#side-header.fusion-mobile-menu-design-modern .fusion-logo-menu-right .fusion-mobile-menu-icons :first-child']['margin-left'] = '0';
		...
		$media_query = '@media only screen and (max-width: ' . ( intval( $side_header_width ) + fusion_strip_unit( Avada_Sanitize::size( Avada()->settings->get( 'side_header_break_point' ) ) ) ) . 'px)';
		...
		$css[$media_query]['.fusion-header-v4 .fusion-logo']['display']  = 'block';
		$css[$media_query]['.fusion-header-v4 .fusion-logo .fusion-header-content-3-wrapper']['display']  = 'block';
		...
		$css[$media_query]['.fusion-header-wrapper .fusion-mobile-menu-design-classic .fusion-contact-info']['text-align']  = 'center';
		$css[$media_query]['.fusion-header-wrapper .fusion-mobile-menu-design-classic .fusion-contact-info']['line-height'] = 'normal';

		$css[$media_query]['.fusion-header-wrapper .fusion-mobile-menu-design-classic .fusion-secondary-menu']['display'] = 'none';

		$css[$media_query]['.fusion-header-wrapper .fusion-mobile-menu-design-classic .fusion-social-links-header']['max-width']     = '100%';
		$css[$media_query]['.fusion-header-wrapper .fusion-mobile-menu-design-classic .fusion-social-links-header']['margin-top']    = '5px';
		$css[$media_query]['.fusion-header-wrapper .fusion-mobile-menu-design-classic .fusion-social-links-header']['text-align']    = 'center';

		$css[$media_query]['.fusion-header-wrapper .fusion-mobile-menu-design-classic .fusion-social-links-header a']['margin-bottom'] = '5px';

		$css[$media_query]['.fusion-header-wrapper .fusion-mobile-menu-design-classic .fusion-header-tagline']['float']       = 'none';
		$css[$media_query]['.fusion-header-wrapper .fusion-mobile-menu-design-classic .fusion-header-tagline']['text-align']  = 'center';
		$css[$media_query]['.fusion-header-wrapper .fusion-mobile-menu-design-classic .fusion-header-tagline']['margin-top']  = '10px';
		$css[$media_query]['.fusion-header-wrapper .fusion-mobile-menu-design-classic .fusion-header-tagline']['line-height'] = '24px';

		$css[$media_query]['.fusion-header-wrapper .fusion-mobile-menu-design-classic .fusion-header-banner']['float']      = 'none';
		$css[$media_query]['.fusion-header-wrapper .fusion-mobile-menu-design-classic .fusion-header-banner']['text-align'] = 'center';
		$css[$media_query]['.fusion-header-wrapper .fusion-mobile-menu-design-classic .fusion-header-banner']['margin']     = '0 auto';
		$css[$media_query]['.fusion-header-wrapper .fusion-mobile-menu-design-classic .fusion-header-banner']['width']      = '100%';
		$css[$media_query]['.fusion-header-wrapper .fusion-mobile-menu-design-classic .fusion-header-banner']['margin-top'] = '20px';
		$css[$media_query]['.fusion-header-wrapper .fusion-mobile-menu-design-classic .fusion-header-banner']['clear']      = 'both';
		...
		if ( 'right' == Avada()->settings->get( 'mobile_menu_text_align' ) ) {
			...
			$css[$media_query]['.fusion-mobile-menu-design-modern .fusion-mobile-nav-holder .fusion-mobile-nav-item .fusion-open-submenu']['padding-left']  = '30px';
			$css[$media_query]['.fusion-mobile-menu-design-modern .fusion-mobile-nav-holder .fusion-mobile-nav-item .fusion-open-submenu']['padding-right'] = '0';
			$css[$media_query]['.fusion-mobile-menu-design-modern .fusion-mobile-nav-holder .fusion-mobile-nav-item a']['padding-left']  = '30px';
			$css[$media_query]['.fusion-mobile-menu-design-modern .fusion-mobile-nav-holder .fusion-mobile-nav-item a']['padding-right'] = '30px';
			$css[$media_query]['.fusion-mobile-menu-design-modern .fusion-mobile-nav-holder .fusion-mobile-nav-item li a']['padding-left']  = '0';
			$css[$media_query]['.fusion-mobile-menu-design-modern .fusion-mobile-nav-holder .fusion-mobile-nav-item li a']['padding-right'] = '39px';
			$css[$media_query]['.fusion-mobile-menu-design-modern .fusion-mobile-nav-holder .fusion-mobile-nav-item li li a']['padding-left']  = '0';
			$css[$media_query]['.fusion-mobile-menu-design-modern .fusion-mobile-nav-holder .fusion-mobile-nav-item li li a']['padding-right'] = '48px';
			$css[$media_query]['.fusion-mobile-menu-design-modern .fusion-mobile-nav-holder .fusion-mobile-nav-item li li li a']['padding-left']  = '0';
			$css[$media_query]['.fusion-mobile-menu-design-modern .fusion-mobile-nav-holder .fusion-mobile-nav-item li li li a']['padding-right'] = '57px';
			$css[$media_query]['.fusion-mobile-menu-design-modern .fusion-mobile-nav-holder .fusion-mobile-nav-item li li li li a']['padding-left']  = '0';
			$css[$media_query]['.fusion-mobile-menu-design-modern .fusion-mobile-nav-holder .fusion-mobile-nav-item li li li li a']['padding-right'] = '66px';
		...
		if ( ( 'right' == Avada()->settings->get( 'mobile_menu_text_align' ) && ! is_rtl() ) ||
			...
			$css[$media_query][avada_implode( $elements )]['padding-right'] = '39px';
			...
			$css[$media_query][avada_implode( $elements )]['padding-right'] = '48px';
			...
			$css[$media_query][avada_implode( $elements )]['padding-right'] = '57px';
		...
		$elements = array(
		 ...
		 $css[$media_query][avada_implode( $elements )]['display'] = 'block';
		 $css[$media_query]['.fusion-countdown .fusion-countdown-heading-wrapper']['text-align'] = 'center';
		 $css[$media_query]['.fusion-countdown .fusion-countdown-counter-wrapper']['margin-top'] = '20px';
		 $css[$media_query]['.fusion-countdown .fusion-countdown-counter-wrapper']['margin-bottom'] = '10px';
		 $css[$media_query]['.fusion-countdown .fusion-dash-title']['display'] = 'block';
		 $css[$media_query]['.fusion-body .fusion-countdown .fusion-dash-title']['padding'] = '0';
		 $css[$media_query]['.fusion-countdown .fusion-dash-title']['font-size'] = '16px';
		 $css[$media_query]['.fusion-countdown .fusion-countdown-link-wrapper']['text-align'] = 'center';

		/**
		 * Events Calendar
		 */
		if ( class_exists( 'Tribe__Events__Main' ) ) {
			$css[$media_query]['.tribe-events-single ul.tribe-related-events li']['margin-right'] = '0';
			$css[$media_query]['.tribe-events-single ul.tribe-related-events li']['width'] = '100%';
		}

		$media_query = '@media only screen and (max-width: ' . ( fusion_strip_unit( Avada_Sanitize::size( Avada()->settings->get( 'side_header_break_point' ) ) ) ) . 'px) and (-webkit-min-device-pixel-ratio: 1.5), only screen and (max-width: ' . ( fusion_strip_unit( Avada_Sanitize::size( Avada()->settings->get( 'side_header_break_point' ) ) ) ) . 'px) and (min-resolution: 144dpi), only screen and (max-width: ' . (    fusion_strip_unit( Avada_Sanitize::size( Avada()->settings->get( 'side_header_break_point' ) ) ) ) . 'px) and (min-resolution: 1.5dppx)';
		 ...
		 */
		if ( class_exists( 'Tribe__Events__Main' ) ) {
			$tribe_media_query = '@media only screen and (max-width: ' . fusion_strip_unit( Avada_Sanitize::size( Avada()->settings->get( 'side_header_break_point' ) ) ) . 'px)';
		...
		$media_query = '@media only screen and (min-width: ' . fusion_strip_unit( Avada_Sanitize::size( Avada()->settings->get( 'side_header_break_point' ) ) ) . 'px)';
		...
		$media_query = '@media screen and (max-width: ' . fusion_strip_unit( Avada_Sanitize::size( Avada()->settings->get( 'side_header_break_point' ) ) ) - 32 . 'px)';
		$css[$media_query]['.fusion-tabs.vertical-tabs .tab-pane']['max-width'] = 'none !important';

		$media_query = '@media screen and (max-width: ' . fusion_strip_unit( Avada_Sanitize::size( Avada()->settings->get( 'side_header_break_point' ) ) ) -33 . 'px)';
		...
		// iPad Portrait Media Query Styles
		$media_query = '@media only screen and (min-device-width: 768px) and (max-device-width: 1024px) and (orientation: portrait)';
		...
		$ipad_portrait[$media_query][avada_implode( $elements )]['margin-left'] = '0';
		...
		$ipad_portrait[$media_query][avada_implode( $elements )]['margin-right'] = '0';

		$ipad_portrait[$media_query]['#wrapper']['width']      = 'auto !important';

		$ipad_portrait[$media_query]['.create-block-format-context']['display'] = 'none';

		$ipad_portrait[$media_query]['.columns .col']['float']      = 'none';
		$ipad_portrait[$media_query]['.columns .col']['width']      = '100% !important';
		$ipad_portrait[$media_query]['.columns .col']['margin']     = '0 0 20px';
		$ipad_portrait[$media_query]['.columns .col']['box-sizing'] = 'border-box';

		$ipad_portrait[$media_query]['.avada-container .columns']['float']         = 'none';
		$ipad_portrait[$media_query]['.avada-container .columns']['width']         = '100%';
		$ipad_portrait[$media_query]['.avada-container .columns']['margin-bottom'] = '20px';

		$ipad_portrait[$media_query]['.avada-container .columns .col']['float'] = 'left';

		$ipad_portrait[$media_query]['.avada-container .col img']['display'] = 'block';
		$ipad_portrait[$media_query]['.avada-container .col img']['margin']  = '0 auto';

		$ipad_portrait[$media_query]['.review']['float'] = 'none';
		$ipad_portrait[$media_query]['.review']['width'] = '100%';

		$elements = array(
			'.fusion-social-networks',
			'.fusion-social-links-footer'
		);
		$ipad_portrait[$media_query][avada_implode( $elements )]['display']    = 'block';
		$ipad_portrait[$media_query][avada_implode( $elements )]['text-align'] = 'center';

		$ipad_portrait[$media_query]['.fusion-social-links-footer']['width'] = 'auto';

		$ipad_portrait[$media_query]['.fusion-social-links-footer .fusion-social-networks']['display'] = 'inline-block';
		$ipad_portrait[$media_query]['.fusion-social-links-footer .fusion-social-networks']['float']   = 'none';

		$ipad_portrait[$media_query]['.fusion-social-links-footer .fusion-social-networks .fusion-social-network-icon:first-child']['margin-left']  = '0';
		$ipad_portrait[$media_query]['.fusion-social-links-footer .fusion-social-networks .fusion-social-network-icon:first-child']['margin-right'] = '0';

		$ipad_portrait[$media_query]['.fusion-social-networks']['padding'] = '0 0 15px';

		$ipad_portrait[$media_query]['.fusion-author .fusion-author-ssocial .fusion-author-tagline']['float']      = 'none';
		$ipad_portrait[$media_query]['.fusion-author .fusion-author-ssocial .fusion-author-tagline']['text-align'] = 'center';
		$ipad_portrait[$media_query]['.fusion-author .fusion-author-ssocial .fusion-author-tagline']['max-width']  = '100%';

		$ipad_portrait[$media_query]['.fusion-author .fusion-author-ssocial .fusion-social-networks']['text-align'] = 'center';

		$ipad_portrait[$media_query]['.fusion-author .fusion-author-ssocial .fusion-social-networks .fusion-social-network-icon:first-child']['margin-left'] = '0';

		$ipad_portrait[$media_query]['.fusion-social-networks:after']['content'] = '""';
		$ipad_portrait[$media_query]['.fusion-social-networks:after']['display'] = 'block';
		$ipad_portrait[$media_query]['.fusion-social-networks:after']['clear']   = 'both';

		$ipad_portrait[$media_query]['.fusion-social-networks li']['float']   = 'none';
		$ipad_portrait[$media_query]['.fusion-social-networks li']['display'] = 'inline-block';

		$elements = array(
			'.fusion-reading-box-container .reading-box.reading-box-center',
			'.fusion-reading-box-container .reading-box.reading-box-right'
		);
		$ipad_portrait[$media_query][avada_implode( $elements )]['text-align'] = 'left';

		$ipad_portrait[$media_query]['.fusion-reading-box-container .continue']['display'] = 'block';

		$ipad_portrait[$media_query]['.fusion-reading-box-container .mobile-button']['display'] = 'none';
		$ipad_portrait[$media_query]['.fusion-reading-box-container .mobile-button']['float']   = 'none';

		$ipad_portrait[$media_query]['.fusion-title']['margin-top']    = '0px !important';
		$ipad_portrait[$media_query]['.fusion-title']['margin-bottom'] = '20px !important';

		if ( class_exists( 'WooCommerce' ) ) {

			$ipad_portrait[$media_query]['#main .cart-empty']['float']         = 'none';
			$ipad_portrait[$media_query]['#main .cart-empty']['text-align']    = 'center';
			$ipad_portrait[$media_query]['#main .cart-empty']['border-top']    = '1px solid';
			$ipad_portrait[$media_query]['#main .cart-empty']['border-bottom'] = 'none';
			$ipad_portrait[$media_query]['#main .cart-empty']['width']         = '100%';
			$ipad_portrait[$media_query]['#main .cart-empty']['line-height']   = 'normal !important';
			$ipad_portrait[$media_query]['#main .cart-empty']['height']        = 'auto !important';
			$ipad_portrait[$media_query]['#main .cart-empty']['margin-bottom'] = '10px';
			$ipad_portrait[$media_query]['#main .cart-empty']['padding-top']   = '10px';

			$ipad_portrait[$media_query]['#main .return-to-shop']['float']          = 'none';
			$ipad_portrait[$media_query]['#main .return-to-shop']['border-top']     = 'none';
			$ipad_portrait[$media_query]['#main .return-to-shop']['border-bottom']  = '1px solid';
			$ipad_portrait[$media_query]['#main .return-to-shop']['width']          = '100%';
			$ipad_portrait[$media_query]['#main .return-to-shop']['text-align']     = 'center';
			$ipad_portrait[$media_query]['#main .return-to-shop']['line-height']    = 'normal !important';
			$ipad_portrait[$media_query]['#main .return-to-shop']['height']         = 'auto !important';
			$ipad_portrait[$media_query]['#main .return-to-shop']['padding-bottom'] = '10px';

			$ipad_portrait[$media_query]['.woocommerce .checkout_coupon .promo-code-heading']['display']       = 'block';
			$ipad_portrait[$media_query]['.woocommerce .checkout_coupon .promo-code-heading']['margin-bottom'] = '10px !important';
			$ipad_portrait[$media_query]['.woocommerce .checkout_coupon .promo-code-heading']['float']         = 'none';
			$ipad_portrait[$media_query]['.woocommerce .checkout_coupon .promo-code-heading']['text-align']    = 'center';

			$ipad_portrait[$media_query]['.woocommerce .checkout_coupon .coupon-contents']['display'] = 'block';
			$ipad_portrait[$media_query]['.woocommerce .checkout_coupon .coupon-contents']['float']   = 'none';
			$ipad_portrait[$media_query]['.woocommerce .checkout_coupon .coupon-contents']['margin']  = '0';

			$ipad_portrait[$media_query]['.woocommerce .checkout_coupon .coupon-input']['display']       = 'block';
			$ipad_portrait[$media_query]['.woocommerce .checkout_coupon .coupon-input']['width']         = 'auto !important';
			$ipad_portrait[$media_query]['.woocommerce .checkout_coupon .coupon-input']['float']         = 'none';
			$ipad_portrait[$media_query]['.woocommerce .checkout_coupon .coupon-input']['text-align']    = 'center';
			$ipad_portrait[$media_query]['.woocommerce .checkout_coupon .coupon-input']['margin-right']  ='0';
			$ipad_portrait[$media_query]['.woocommerce .checkout_coupon .coupon-input']['margin-bottom'] = '10px !important';

			$ipad_portrait[$media_query]['.woocommerce .checkout_coupon .coupon-button']['display']      = 'block';
			$ipad_portrait[$media_query]['.woocommerce .checkout_coupon .coupon-button']['margin-right'] = '0';
			$ipad_portrait[$media_query]['.woocommerce .checkout_coupon .coupon-button']['float']        = 'none';
			$ipad_portrait[$media_query]['.woocommerce .checkout_coupon .coupon-button']['text-align']   = 'center';
		...
		if ( 'auto' != Avada()->settings->get( 'page_title_mobile_height' ) ) {
			...
			$ipad_portrait[$media_query]['.fusion-body .fusion-page-title-bar']['height'] = Avada_Sanitize::size( Avada()->settings->get( 'page_title_mobile_height' ) );

		} else {

			$ipad_portrait[$media_query]['.fusion-body .fusion-page-title-bar']['padding-top']    = '10px';
			$ipad_portrait[$media_query]['.fusion-body .fusion-page-title-bar']['padding-bottom'] = '10px';
			$ipad_portrait[$media_query]['.fusion-body .fusion-page-title-bar']['height']         = 'auto';
		...
		$ipad_portrait[$media_query][avada_implode( $elements )]['display']     = 'block';
		$ipad_portrait[$media_query][avada_implode( $elements )]['float']       = 'none';
		$ipad_portrait[$media_query][avada_implode( $elements )]['width']       = '100%';
		$ipad_portrait[$media_query][avada_implode( $elements )]['line-height'] = 'normal';

		$ipad_portrait[$media_query]['.fusion-page-title-bar-left .fusion-page-title-secondary']['text-align'] = 'left';

		$ipad_portrait[$media_query]['.fusion-page-title-bar-left .searchform']['display']   = 'block';
		$ipad_portrait[$media_query]['.fusion-page-title-bar-left .searchform']['max-width'] = '100%';

		$ipad_portrait[$media_query]['.fusion-page-title-bar-right .fusion-page-title-secondary']['text-align'] = 'right';

		$ipad_portrait[$media_query]['.fusion-page-title-bar-right .searchform']['max-width'] = '100%';

		if ( 'auto' != Avada()->settings->get( 'page_title_mobile_height' ) ) {

			$ipad_portrait[$media_query]['.fusion-page-title-row']['display']    = 'table';
			$ipad_portrait[$media_query]['.fusion-page-title-row']['width']      = '100%';
			$ipad_portrait[$media_query]['.fusion-page-title-row']['height']      = '100%';
			$ipad_portrait[$media_query]['.fusion-page-title-row']['min-height'] = fusion_strip_unit( Avada()->settings->get( 'page_title_mobile_height' ) ) - 20 . 'px';

			$ipad_portrait[$media_query]['.fusion-page-title-wrapper']['display']        = 'table-cell';
			$ipad_portrait[$media_query]['.fusion-page-title-wrapper']['vertical-align'] = 'middle';

		}

		$ipad_portrait[$media_query]['.sidebar .social_links .social li']['width']        = 'auto';
		$ipad_portrait[$media_query]['.sidebar .social_links .social li']['margin-right'] = '5px';

		$ipad_portrait[$media_query]['#comment-input']['margin-bottom'] = '0';

		$ipad_portrait[$media_query]['#comment-input input']['width']         = '90%';
		$ipad_portrait[$media_query]['#comment-input input']['float']         = 'none !important';
		$ipad_portrait[$media_query]['#comment-input input']['margin-bottom'] = '10px';

		$ipad_portrait[$media_query]['#comment-textarea textarea']['width'] = '90%';

		$ipad_portrait[$media_query]['.pagination']['margin-top'] = '40px';

		$ipad_portrait[$media_query]['.portfolio-one .portfolio-item .image']['float']         = 'none';
		$ipad_portrait[$media_query]['.portfolio-one .portfolio-item .image']['width']         = 'auto';
		$ipad_portrait[$media_query]['.portfolio-one .portfolio-item .image']['height']        = 'auto';
		$ipad_portrait[$media_query]['.portfolio-one .portfolio-item .image']['margin-bottom'] = '20px';

		$ipad_portrait[$media_query]['h5.toggle span.toggle-title']['width'] = '80%';

		$ipad_portrait[$media_query]['#wrapper .sep-boxed-pricing .panel-wrapper']['padding'] = '0';
		...
		$ipad_portrait[$media_query][avada_implode( $elements )]['float']         = 'none';
		$ipad_portrait[$media_query][avada_implode( $elements )]['margin-bottom'] = '10px';
		$ipad_portrait[$media_query][avada_implode( $elements )]['margin-left']   = '0';
		$ipad_portrait[$media_query][avada_implode( $elements )]['width']         = '100%';

		$ipad_portrait[$media_query]['.share-box']['height'] = 'auto';

		$ipad_portrait[$media_query]['#wrapper .share-box h4']['float']       = 'none';
		$ipad_portrait[$media_query]['#wrapper .share-box h4']['line-height'] = '20px !important';
		$ipad_portrait[$media_query]['#wrapper .share-box h4']['padding']     = '0';

		$ipad_portrait[$media_query]['.share-box ul']['float']          = 'none';
		$ipad_portrait[$media_query]['.share-box ul']['overflow']       = 'hidden';
		$ipad_portrait[$media_query]['.share-box ul']['padding']        = '0 25px';
		$ipad_portrait[$media_query]['.share-box ul']['padding-bottom'] = '15px';
		$ipad_portrait[$media_query]['.share-box ul']['margin-top']     = '0px';

		$ipad_portrait[$media_query]['.project-content .project-description']['float'] = 'none !important';

		$ipad_portrait[$media_query]['.project-content .fusion-project-description-details']['margin-bottom'] = '50px';

		$elements = array(
			'.project-content .project-description',
			'.project-content .project-info'
		);
		$ipad_portrait[$media_query][avada_implode( $elements )]['width'] = '100% !important';

		$ipad_portrait[$media_query]['.portfolio-half .flexslider']['width'] = '100%';

		$ipad_portrait[$media_query]['.portfolio-half .project-content']['width'] = '100% !important';

		$ipad_portrait[$media_query]['#style_selector']['display'] = 'none';

		$elements = array(
			'.portfolio-tabs',
			'.faq-tabs'
		);
		$ipad_portrait[$media_query][avada_implode( $elements )]['height']              = 'auto';
		$ipad_portrait[$media_query][avada_implode( $elements )]['border-bottom-width'] = '1px';
		$ipad_portrait[$media_query][avada_implode( $elements )]['border-bottom-style'] = 'solid';

		$elements = array(
			'.portfolio-tabs li',
			'.faq-tabs li'
		);
		$ipad_portrait[$media_query][avada_implode( $elements )]['float']         = 'left';
		$ipad_portrait[$media_query][avada_implode( $elements )]['margin-right']  = '30px';
		$ipad_portrait[$media_query][avada_implode( $elements )]['border-bottom'] = '0';

		$elements = array(
			'.ls-avada .ls-nav-prev',
			'.ls-avada .ls-nav-next'
		);
		$ipad_portrait[$media_query][avada_implode( $elements )]['display'] = 'none !important';
		...
		$ipad_portrait[$media_query]['#footer .social-networks']['width']    = '100%';
		$ipad_portrait[$media_query]['#footer .social-networks']['margin']   = '0 auto';
		$ipad_portrait[$media_query]['#footer .social-networks']['position'] = 'relative';
		$ipad_portrait[$media_query]['#footer .social-networks']['left']     = '-11px';

		$ipad_portrait[$media_query]['.tab-holder .tabs']['height'] = 'auto !important';
		$ipad_portrait[$media_query]['.tab-holder .tabs']['width']  = '100% !important';

		$ipad_portrait[$media_query]['.shortcode-tabs .tab-hold .tabs li']['width'] = '100% !important';

		$elements = array(
			'body .shortcode-tabs .tab-hold .tabs li',
			'body.dark .sidebar .tab-hold .tabs li'
		);
		$ipad_portrait[$media_query][avada_implode( $elements )]['border-right'] = 'none !important';

		$ipad_portrait[$media_query]['.error-message']['line-height'] = '170px';
		$ipad_portrait[$media_query]['.error-message']['margin-top']  = '20px';

		$ipad_portrait[$media_query]['.error_page .useful_links']['width']        = '100%';
		$ipad_portrait[$media_query]['.error_page .useful_links']['padding-left'] = '0';

		$ipad_portrait[$media_query]['.fusion-google-map']['width']         = '100% !important';
		$ipad_portrait[$media_query]['.fusion-google-map']['margin-bottom'] = '20px !important';

		$ipad_portrait[$media_query]['.social_links_shortcode .social li']['width'] = '10% !important';

		$ipad_portrait[$media_query]['#wrapper .ei-slider']['width']  = '100% !important';
		$ipad_portrait[$media_query]['#wrapper .ei-slider']['height'] = '200px !important';

		$ipad_portrait[$media_query]['.progress-bar']['margin-bottom'] = '10px !important';

		$ipad_portrait[$media_query]['.fusion-blog-layout-medium-alternate .fusion-post-content']['float']      = 'none';
		$ipad_portrait[$media_query]['.fusion-blog-layout-medium-alternate .fusion-post-content']['width']      = '100% !important';
		$ipad_portrait[$media_query]['.fusion-blog-layout-medium-alternate .fusion-post-content']['margin-top'] = '20px';

		$ipad_portrait[$media_query]['#wrapper .content-boxes-icon-boxed .content-wrapper-boxed']['min-height']     = 'inherit !important';
		$ipad_portrait[$media_query]['#wrapper .content-boxes-icon-boxed .content-wrapper-boxed']['padding-bottom'] = '20px';
		$ipad_portrait[$media_query]['#wrapper .content-boxes-icon-boxed .content-wrapper-boxed']['padding-left']   = '3%';
		$ipad_portrait[$media_query]['#wrapper .content-boxes-icon-boxed .content-wrapper-boxed']['padding-right']  = '3%';

		$elements = array(
			'#wrapper .content-boxes-icon-on-top .content-box-column',
			'#wrapper .content-boxes-icon-boxed .content-box-column'
		);
		$ipad_portrait[$media_query][avada_implode( $elements )]['margin-bottom'] = '55px';

		$ipad_portrait[$media_query]['.fusion-counters-box .fusion-counter-box']['margin-bottom'] = '20px';
		$ipad_portrait[$media_query]['.fusion-counters-box .fusion-counter-box']['padding']       = '0 15px';

		$ipad_portrait[$media_query]['.fusion-counters-box .fusion-counter-box:last-child']['margin-bottom'] = '0';

		$ipad_portrait[$media_query]['.popup']['display'] = 'none !important';

		$ipad_portrait[$media_query]['.share-box .social-networks']['text-align'] = 'left';
		...
		if ( class_exists( 'WooCommerce' ) ) {
			...
			$ipad_portrait[$media_query][avada_implode( $elements )]['float']        = 'none !important';
			$ipad_portrait[$media_query][avada_implode( $elements )]['margin-left']  = 'auto !important';
			$ipad_portrait[$media_query][avada_implode( $elements )]['margin-right'] = 'auto !important';

			$ipad_portrait[$media_query]['#wrapper .catalog-ordering > .fusion-grid-list-view']['float']        = 'left !important';
			$ipad_portrait[$media_query]['#wrapper .catalog-ordering > .fusion-grid-list-view']['margin-left']  = '0 !important';
			$ipad_portrait[$media_query]['#wrapper .catalog-ordering > .fusion-grid-list-view']['margin-right'] = '0 !important';
			...
			$ipad_portrait[$media_query][avada_implode( $elements )]['margin'] = '0 !important';
			$ipad_portrait[$media_query][avada_implode( $elements )]['width']  = '100%';

			$ipad_portrait[$media_query]['.catalog-ordering']['margin-bottom'] = '50px';

			$ipad_portrait[$media_query]['.catalog-ordering .order']['width'] = '33px';
			...
			$ipad_portrait[$media_query]['.order-dropdown > li:hover > ul']['display']  = 'block';
			$ipad_portrait[$media_query]['.order-dropdown > li:hover > ul']['position'] = 'relative';
			$ipad_portrait[$media_query]['.order-dropdown > li:hover > ul']['top']      = '0';

			$ipad_portrait[$media_query]['#wrapper .orderby-order-container']['overflow']      = 'visible';
			$ipad_portrait[$media_query]['#wrapper .orderby-order-container']['width']         = 'auto';
			$ipad_portrait[$media_query]['#wrapper .orderby-order-container']['margin-bottom'] = '10px';
			$ipad_portrait[$media_query]['#wrapper .orderby-order-container']['float']         = 'left';

			$ipad_portrait[$media_query]['#wrapper .orderby.order-dropdown']['float']        = 'left';
			$ipad_portrait[$media_query]['#wrapper .orderby.order-dropdown']['margin-right'] = '7px';

			$ipad_portrait[$media_query]['#wrapper .catalog-ordering .sort-count.order-dropdown']['width']        = '215px';
			$ipad_portrait[$media_query]['#wrapper .catalog-ordering .sort-count.order-dropdown']['float']        = 'left !important';
			$ipad_portrait[$media_query]['#wrapper .catalog-ordering .sort-count.order-dropdown']['margin-left']  = '7px !important';
			$ipad_portrait[$media_query]['#wrapper .catalog-ordering .sort-count.order-dropdown']['margin-right'] = '7px !important';

			$ipad_portrait[$media_query]['#wrapper .sort-count.order-dropdown ul a']['width'] = '215px';

			$ipad_portrait[$media_query]['#wrapper .catalog-ordering .order']['float']         = 'left !important';
			$ipad_portrait[$media_query]['#wrapper .catalog-ordering .order']['margin-bottom'] = '0 !important';
			...
			$ipad_portrait[$media_query][avada_implode( $elements )]['clear'] = 'none !important';

			$ipad_portrait[$media_query]['#main .products li:nth-child(3n+1)']['clear'] = 'both !important';
			...
			$ipad_portrait[$media_query][avada_implode( $elements )]['width']        = '32.3% !important';
			$ipad_portrait[$media_query][avada_implode( $elements )]['float']        = 'left !important';
			$ipad_portrait[$media_query][avada_implode( $elements )]['margin-right'] = '1% !important';
			...
			$ipad_portrait[$media_query]['.avada-myaccount-data .my_account_orders .order-number']['padding-right'] = '8px';

			$ipad_portrait[$media_query]['.avada-myaccount-data .my_account_orders .order-actions']['padding-left'] = '8px';

			$ipad_portrait[$media_query]['.shop_table .product-name']['width'] = '35%';
			...
			$ipad_portrait[$media_query][avada_implode( $elements )]['float']        = 'none';
			$ipad_portrait[$media_query][avada_implode( $elements )]['margin-left']  = 'auto';
			$ipad_portrait[$media_query][avada_implode( $elements )]['margin-right'] = 'auto';
			$ipad_portrait[$media_query][avada_implode( $elements )]['width']        = '100% !important';
			...
			$ipad_portrait[$media_query][avada_implode( $elements )]['margin-bottom'] = '20px';

			$ipad_portrait[$media_query]['.shop_table .product-thumbnail']['float'] = 'none';

			$ipad_portrait[$media_query]['.product-info']['margin-left'] = '0';
			$ipad_portrait[$media_query]['.product-info']['margin-top']  = '10px';

			$ipad_portrait[$media_query]['.product .entry-summary div .price']['float'] = 'none';

			$ipad_portrait[$media_query]['.product .entry-summary .woocommerce-product-rating']['float']       = 'none';
			$ipad_portrait[$media_query]['.product .entry-summary .woocommerce-product-rating']['margin-left'] = '0';

			$elements = array(
				'.woocommerce-tabs .tabs',
				'.woocommerce-side-nav'
			);
			$ipad_portrait[$media_query][avada_implode( $elements )]['margin-bottom'] = '25px';

			$ipad_portrait[$media_query]['.woocommerce-tabs .panel']['width']   = '91% !important';
			$ipad_portrait[$media_query]['.woocommerce-tabs .panel']['padding'] = '4% !important';

			$ipad_portrait[$media_query]['#reviews li .avatar']['display'] = 'none';

			$ipad_portrait[$media_query]['#reviews li .comment-text']['width']       = '90% !important';
			$ipad_portrait[$media_query]['#reviews li .comment-text']['margin-left'] = '0 !important';
			$ipad_portrait[$media_query]['#reviews li .comment-text']['padding']     = '5% !important';

			$ipad_portrait[$media_query]['.woocommerce-container .social-share']['overflow'] = 'hidden';

			$ipad_portrait[$media_query]['.woocommerce-container .social-share li']['display']       = 'block';
			$ipad_portrait[$media_query]['.woocommerce-container .social-share li']['float']         = 'left';
			$ipad_portrait[$media_query]['.woocommerce-container .social-share li']['margin']        = '0 auto';
			$ipad_portrait[$media_query]['.woocommerce-container .social-share li']['border-right']  = '0 !important';
			$ipad_portrait[$media_query]['.woocommerce-container .social-share li']['border-left']   = '0 !important';
			$ipad_portrait[$media_query]['.woocommerce-container .social-share li']['padding-left']  = '0 !important';
			$ipad_portrait[$media_query]['.woocommerce-container .social-share li']['padding-right'] = '0 !important';
			$ipad_portrait[$media_query]['.woocommerce-container .social-share li']['width']         = '25%';

			$ipad_portrait[$media_query]['.has-sidebar .woocommerce-container .social-share li']['width'] = '50%';

			$ipad_portrait[$media_query]['.myaccount_user_container span']['width']        = '100%';
			$ipad_portrait[$media_query]['.myaccount_user_container span']['float']        = 'none';
			$ipad_portrait[$media_query]['.myaccount_user_container span']['display']      = 'block';
			$ipad_portrait[$media_query]['.myaccount_user_container span']['padding']      = '10px 0px';
			$ipad_portrait[$media_query]['.myaccount_user_container span']['border-right'] = '0';

			if ( is_rtl() ) {
				$ipad_portrait[$media_query]['.rtl .myaccount_user_container span']['border-left'] = '0';
			}
			...
			$ipad_portrait[$media_query][avada_implode( $elements )]['width']   = '100%';
			$ipad_portrait[$media_query][avada_implode( $elements )]['margin']  = '0 !important';
			$ipad_portrait[$media_query][avada_implode( $elements )]['padding'] = '0';

			$ipad_portrait[$media_query]['.shop_table .product-thumbnail']['padding'] = '10px 0px';

			$ipad_portrait[$media_query]['.product .images']['margin-bottom'] = '30px';

			$ipad_portrait[$media_query]['#customer_login_box .button']['float']         = 'left';
			$ipad_portrait[$media_query]['#customer_login_box .button']['margin-bottom'] = '15px';

			$ipad_portrait[$media_query]['#customer_login_box .remember-box']['clear']   = 'both';
			$ipad_portrait[$media_query]['#customer_login_box .remember-box']['display'] = 'block';
			$ipad_portrait[$media_query]['#customer_login_box .remember-box']['padding'] = '0';
			$ipad_portrait[$media_query]['#customer_login_box .remember-box']['width']   = '125px';
			$ipad_portrait[$media_query]['#customer_login_box .remember-box']['float']   = 'left';

			$ipad_portrait[$media_query]['#customer_login_box .lost_password']['float'] = 'left';

			$elements = array(
				'#wrapper .product .images',
				'#wrapper .product .summary.entry-summary'
			);
			$ipad_portrait[$media_query][avada_implode( $elements )]['width'] = '50% !important';
			$ipad_portrait[$media_query][avada_implode( $elements )]['float'] = 'left !important';

			$ipad_portrait[$media_query]['#wrapper .product .summary.entry-summary']['width']       = '48% !important';
			$ipad_portrait[$media_query]['#wrapper .product .summary.entry-summary']['margin-left'] = '2% !important';

			$ipad_portrait[$media_query]['#wrapper .woocommerce-tabs .tabs']['width'] = '24% !important';
			$ipad_portrait[$media_query]['#wrapper .woocommerce-tabs .tabs']['float'] = 'left !important';

			$ipad_portrait[$media_query]['#wrapper .woocommerce-tabs .panel']['float']   = 'right !important';
			$ipad_portrait[$media_query]['#wrapper .woocommerce-tabs .panel']['width']   = '70% !important';
			$ipad_portrait[$media_query]['#wrapper .woocommerce-tabs .panel']['padding'] = '4% !important';
			...
			$ipad_portrait[$media_query][avada_implode( $elements )]['padding-left']  = '0 !important';
			$ipad_portrait[$media_query][avada_implode( $elements )]['padding-right'] = '0 !important';

		}

		$ipad_portrait[$media_query]['body #small-nav']['visibility'] = 'visible !important';
		...
		$ipad_portrait[$media_query][avada_implode( $elements )]['float']      = 'none !important';
		$ipad_portrait[$media_query][avada_implode( $elements )]['width']      = '100% !important';
		$ipad_portrait[$media_query][avada_implode( $elements )]['box-sizing'] = 'border-box';

		$ipad_portrait[$media_query]['#nav-uber #megaMenu']['width'] = '100%';

		$ipad_portrait[$media_query]['.fullwidth-box']['background-attachment'] = 'scroll';

		$ipad_portrait[$media_query]['#toTop']['bottom']        = '30px';
		$ipad_portrait[$media_query]['#toTop']['border-radius'] = '4px';
		$ipad_portrait[$media_query]['#toTop']['height']        = '40px';
		$ipad_portrait[$media_query]['#toTop']['z-index']       = '10000';

		$ipad_portrait[$media_query]['#toTop:before']['line-height'] = '38px';

		$ipad_portrait[$media_query]['#toTop:hover']['background-color'] = '#333333';

		$ipad_portrait[$media_query]['.no-mobile-totop .to-top-container']['display'] = 'none';

		$ipad_portrait[$media_query]['.no-mobile-slidingbar #slidingbar-area']['display'] = 'none';

		$ipad_portrait[$media_query]['.tfs-slider .slide-content-container .btn']['min-height']    = '0 !important';
		$ipad_portrait[$media_query]['.tfs-slider .slide-content-container .btn']['padding-left']  = '20px';
		$ipad_portrait[$media_query]['.tfs-slider .slide-content-container .btn']['padding-right'] = '20px !important';
		$ipad_portrait[$media_query]['.tfs-slider .slide-content-container .btn']['height']        = '26px !important';
		$ipad_portrait[$media_query]['.tfs-slider .slide-content-container .btn']['line-height']   = '26px !important';

		$ipad_portrait[$media_query]['.fusion-soundcloud iframe']['width'] = '100%';
		...
		$ipad_portrait[$media_query][avada_implode( $elements )]['clear'] = 'both';
		...
		$ipad_portrait[$media_query][avada_implode( $elements )]['width'] = '33.33% !important';
		$ipad_portrait[$media_query][avada_implode( $elements )]['float'] = 'left !important';
		...
		$ipad_portrait[$media_query][avada_implode( $elements )]['margin-bottom'] = '40px';
		...
		if( is_rtl() ) {
			$ipad_portrait[$media_query][avada_implode( $elements )]['position']      = 'relative';
			$ipad_portrait[$media_query][avada_implode( $elements )]['float']         = 'right';
			$ipad_portrait[$media_query][avada_implode( $elements )]['margin-left']   = '4%';
			$ipad_portrait[$media_query][avada_implode( $elements )]['margin-right']  = '0%';
			$ipad_portrait[$media_query][avada_implode( $elements )]['margin-bottom'] = '20px';
		} else {
			$ipad_portrait[$media_query][avada_implode( $elements )]['position']      = 'relative';
			$ipad_portrait[$media_query][avada_implode( $elements )]['float']         = 'left';
			$ipad_portrait[$media_query][avada_implode( $elements )]['margin-right']  = '4%';
			$ipad_portrait[$media_query][avada_implode( $elements )]['margin-bottom'] = '20px';
		}

		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-one-sixth']['width']    = '13.3333%';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-five-sixth']['width']   = '82.6666%';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-one-fifth']['width']    = '16.8%';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-two-fifth']['width']    = '37.6%';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-three-fifth']['width']  = '58.4%';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-four-fifth']['width']   = '79.2%';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-one-fourth']['width']   = '22%';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-three-fourth']['width'] = '74%';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-one-third']['width']    = '30.6666%';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-two-third']['width']    = '65.3333%';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-one-half']['width']     = '48%';

		// No spacing Columns

		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-spacing-no']['margin-left']  = '0';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-spacing-no']['margin-right'] = '0';

		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-one-sixth.fusion-spacing-no']['width']    = '16.6666666667% !important';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-five-sixth.fusion-spacing-no']['width']   = '83.333333333% !important';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-one-fifth.fusion-spacing-no']['width']    = '20% !important';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-two-fifth.fusion-spacing-no']['width']    = '40% !important';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-three-fifth.fusion-spacing-no']['width']  = '60% !important';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-four-fifth.fusion-spacing-no']['width']   = '80% !important';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-one-fourth.fusion-spacing-no']['width']   = '25% !important';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-three-fourth.fusion-spacing-no']['width'] = '75% !important';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-one-third.fusion-spacing-no']['width']    = '33.33333333% !important';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-two-third.fusion-spacing-no']['width']    = '66.66666667% !important';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-one-half.fusion-spacing-no']['width']     = '50% !important';

		if( is_rtl() ) {
			$ipad_portrait[$media_query]['.fusion-layout-column.fusion-column-last']['clear'] = 'left';
		} else {
			$ipad_portrait[$media_query]['.fusion-layout-column.fusion-column-last']['clear'] = 'right';
		}
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-column-last']['zoom']         = '1';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-column-last']['margin-left']  = '0';
		$ipad_portrait[$media_query]['.fusion-layout-column.fusion-column-last']['margin-right'] = '0';

		$ipad_portrait[$media_query]['.fusion-column.fusion-spacing-no']['margin-bottom'] = '0';
		$ipad_portrait[$media_query]['.fusion-column.fusion-spacing-no']['width']         = '100% !important';

		$ipad_portrait[$media_query]['.sidebar']['margin-left'] = '0 !important';
		$ipad_portrait[$media_query]['.sidebar']['width']       = '25% !important';

		$ipad_portrait[$media_query]['#content']['margin-left'] = '0 !important';

		$elements = array(
			'.has-sidebar #main #content',
			'#main #content.with-sidebar'
		);
		$ipad_portrait[$media_query][avada_implode( $elements )]['width'] = '72% !important';

		$ipad_portrait[$media_query]['.sidebar-position-left .sidebar']['float'] = 'left !important';

		$ipad_portrait[$media_query]['.sidebar-position-left #content']['float'] = 'right !important';

		$ipad_portrait[$media_query]['.sidebar-position-right .sidebar']['float'] = 'right !important';

		$ipad_portrait[$media_query]['.sidebar-position-right #content']['float'] = 'left !important';

		$ipad_portrait[$media_query]['#sidebar-2']['clear'] = 'left';
		...
		$ipad_portrait[$media_query][avada_implode( $elements )]['background-attachment'] = 'scroll !important';
		...
		$ipad_portrait[$media_query][avada_implode( $elements )]['padding-left']  = '0px !important';
		$ipad_portrait[$media_query][avada_implode( $elements )]['padding-right'] = '0px !important';

		$ipad_portrait[$media_query]['.error-message']['font-size'] = '130px';
	...
	if ( Avada()->settings->get( 'responsive' ) && get_post_meta( $c_pageID, 'pyre_page_title_height', true ) ) {
